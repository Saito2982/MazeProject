...
namespace naichilab
{
    public class RankingSceneManager : MonoBehaviour
    {
        ...
        [SerializeField]
        GameObject rankingNodePrefab;
        [SerializeField]
        GameObject readingNodePrefab;
        [SerializeField]
        GameObject notFoundNodePrefab;

        private string sceneName;

        private const string OBJECT_ID = "objectId";
        private string _objectid = null;
        private string RankingDataClassName;
		...
		{
			//2017.2.0b3でScrollViewContentを追加しても描画されない場合がある。
			//親maskをOFF/ONすると直る
